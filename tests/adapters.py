...
import torch
from cs336_systems import ddp, zero, fsdp
...
def get_flashattention_autograd_function_triton() -> type:
    ...
    Returns:
        A class object (not an instance of the class)
    """
    # return flash_attention.FlashAttention
    pass
...
def get_ddp(module: torch.nn.Module) -> torch.nn.Module:
    ...
    return ddp.OverlapDDP(module)
    # return ddp.NaiveDDP(module)
    # return ddp.FlattenDDP(module)
...
def get_fsdp(module: torch.nn.Module, compute_dtype: torch.dtype | None = None) -> torch.nn.Module:
    ...
    return fsdp.FSDP(module, compute_dtype=compute_dtype)
...
def fsdp_gather_full_params(fsdp_model: torch.nn.Module) -> dict[str, torch.Tensor]:
    ...
    """
    return fsdp.fsdp_gather_full_params(fsdp_model)
...
def get_sharded_optimizer(params, optimizer_cls: type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    return zero.Zero1(params, optimizer_cls, **kwargs)
